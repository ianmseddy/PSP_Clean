...
#This is some diagnostic work to assess whether a DEM will be an accurate stand-in for elevation at PSP plots
#Elevation is needed to get climate conditions at each site from ClimateNA, but only a few PSP sites have elevation
#Comparisons running ClimateNA with true elevation from PSPs and with DEM elevation show the DEM is acceptable and 
#far superior to running with no elevation data at all. 
